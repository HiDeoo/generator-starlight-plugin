...
3. [Start the development server](https://starlight.astro.build/getting-started/#start-the-development-server) to preview the <% if(theme){ %>theme<% } else{ %>plugin<% } %> in action.
